...
def run_gstar():
    while True:
        ...
        sites =[["youtube","https://youtube.com"], ["wikipedia","https://www.wikipedia.com"], ["google","https://www.google.com"],
                ["my leatcode profile", "https://leetcode.com/u/atulv7408/"],
                ["my linkedin profile", "https://www.linkedin.com/in/atul-verma-6570bb230/"], ["my college sim", "https://glbg.servergi.com:8072/ISIMGLB/Login"],
                ["geeksforgeeks", "https://www.geeksforgeeks.org/"], ["gmail", "https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox"],
                ["gl bajaj website","https://www.glbitm.org/"],["my git profile","https://github.com/atul7408"],
                ["hackerrank profile","https://www.geeksforgeeks.org/user/atulv7408/"], ["chat gpt","https://chat.openai.com/"],
        ...
        if 'play' in command:
            ...
            talk('your name is Atul Verma. How can I help you Atul')
